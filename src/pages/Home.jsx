         ...
         <section>
            <div className='container'>
               <div className='flex items-center justify-between flex-col lg:flex-row'>
                  ...
                  {/* <div className='relative flex w-3/4 justify-end z-10 mt-[50px] lg:mt-0 xl:w-[770px] '> */}
                  <div className='relative flex w-[80%] justify-end z-30 mb-[50px] md:w-1/2 md:mt-[50px] lg:mt-0 lg:w-[750px] order-1 md:order-2 '>
                     ...
                     {/* <div className='absolute bg-white w-[150px] lg:w-[248px] bottom-[50px] md:bottom-[80px] left-[50%] md:left-[14%] z-20 p-2 pb-3 lg:pb-6 lg:px-4 lg:pt-4 rounded-xl '> */}
